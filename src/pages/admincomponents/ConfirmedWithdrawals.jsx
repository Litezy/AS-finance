...
const ConfirmedWithdrawals = () => {
    ...
    const fetchConfirmedWithdraws = useCallback(async ()=>{
        setLoading(true)
        try {
            const response = await GetApi(Apis.admins.confirmed_withdraws)
